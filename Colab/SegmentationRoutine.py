...
def segment_unsupervised(overview, num_classes = 8, tilesize_learn = 64, tilesize_cluster = 128, shiftcount = 2, epochs = 1, model = None, labelsureonly = True, decisionthresh = 0.5):
